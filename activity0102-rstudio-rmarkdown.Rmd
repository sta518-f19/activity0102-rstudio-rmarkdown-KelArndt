...
Both r-values show that the dino and star datasets have weak, negative association with the star r-value, -0.0629, being just a tad bit weaker than the dino r-value, -0.0644.
...
Both r-values show a weak, negative association for the datasets of dino and circle. The association of the circle dataset, -0.0683 however is slightly stronger than that of dino, -0.0644.
